...
//    this is the albums activity, one of the subscreens of mymusic screens
//    can navigate to 4 main screens
//    is aimed to show the list of albums name which can be stored from the mp3 music file from the storage
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonAlbumsActivityHome.setOnClickListener(new View.OnClickListener() {
            @Override
...
//        using data binding to find and set OnClickListener to Search button in the layout file of this activity
        binding.buttonAlbumsActivitySearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
...
//        using data binding to find and set OnClickListener Now Playing button in the layout file of this activity
        binding.buttonAlbumsActivityNowPlaying.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        binding.buttonAlbumsActivityMyMusic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Create a new intent to open My Music Activity
                Intent myMusicIntent = new Intent(AlbumsActivity.this, MyMusicActivity.class);
                //Start the new activity
